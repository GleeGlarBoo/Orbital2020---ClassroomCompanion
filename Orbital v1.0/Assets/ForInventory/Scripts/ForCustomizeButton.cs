...
public class ForCustomizeButton : MonoBehaviour
{
    ...
    public void OnClick()
    {
        ...
        */
        ...
        itemManager.instance.Customizing = !itemManager.instance.Customizing;           // toggling too.

        itemManager.instance.InventoryRefresh();
    }
}
