...
public class EngQuizGameManager : MonoBehaviour
{
    // UI and interfaces
    ...
    private static List<EngQuestion> unansweredQuestions;
    private static int questionCount = 0;       // count and display the question number, will be reset whenever user leaves the quiz


    private EngQuestion currentQuestion;

    public List<EngQuestion> answeredQuestions;       // to be used for the summary page
    ...
    private void Start()
    {
       ...
       // Debug.Log(relatedQuestions.Count);
        ...
        {
            unansweredQuestions = selectedQuestions.ToList<EngQuestion>();
        }
    ...
    public void SetNextQuestionOrEnd()
    {
        ...
        if (questionCount == 5)
        {
            ...
            EndQuiz(1);                                             // CHANGE ACCORDING TO SUBJECT
    ...
    void DisplayQuestionTopic(int questionTopicNum, TextMeshProUGUI topicTextToBeDisplayed)
    {
        ...
        {
            case 0:
                topicTextToBeDisplayed.text = "(Topic: Text Editing)";
                break;
            case 1:
                topicTextToBeDisplayed.text = "(Topic: Comprehension Skills 1)";
                break;
            case 2:
                topicTextToBeDisplayed.text = "(Topic: Narrative Writing 1)";
                break;
            case 3:
                topicTextToBeDisplayed.text = "(Topic: Grammar 1)";
                break;
            case 4:
                topicTextToBeDisplayed.text = "(Topic: Comprehension Skills 2)";
                break;
            case 5:
                topicTextToBeDisplayed.text = "(Topic: Situational Writing 1)";
                break;
            case 6:
                topicTextToBeDisplayed.text = "(Topic: Grammar 2)";
                break;
            case 7:
                topicTextToBeDisplayed.text = "(Topic: Summary Writing 1)";
                break;
            case 8:
                topicTextToBeDisplayed.text = "(Topic: Situational Writing 2)";
                break;
            case 9:
                topicTextToBeDisplayed.text = "(Topic: Grammar 3)";
                break;
            case 10:
                topicTextToBeDisplayed.text = "(Topic: Summary Writing 2)";
                break;
            default:
