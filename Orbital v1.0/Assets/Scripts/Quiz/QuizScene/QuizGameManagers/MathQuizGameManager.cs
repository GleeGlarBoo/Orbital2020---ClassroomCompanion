...
public class MathQuizGameManager : MonoBehaviour
{
    ...
    private static int questionCount = 0;       // count and display the question numbber, will be reset whenever user leaves the quiz


    private Question currentQuestion;

    public List<Question> answeredQuestions;       // to be used for the summary page
    ...
    private void Start()
    {
       ...
       // Debug.Log(relatedQuestions.Count);
        ...
        {
            unansweredQuestions = selectedQuestions.ToList<Question>();
        }
    ...
    public void SetNextQuestionOrEnd()
    {
        ...
        if (questionCount == 5)
        {
            ...
            EndQuiz(2);                                             // CHANGE ACCORDING TO SUBJECT
    ...
    public void correctnessChecker(int index)
    {
        ...
        }                                               // - 1 since question count starts from index of 1
        else
        {
            //Debug.Log("Wrong!");
            Debug.Log(questionCount);
    ...
    // FOR UI
    void DisplayQuestionTopic(int questionTopicNum, TextMeshProUGUI topicTextToBeDisplayed)         // takes in the topic TMP too for more portability and used below
    {
        ...
        {
            case 0:
                topicTextToBeDisplayed.text = "(Topic: Primes, Highest Common Factor and Lowest Common Multiple)";
                break;
            case 1:
                topicTextToBeDisplayed.text = "(Topic: Integers, Rational Numbers and Real Numbers)";
                break;
            case 2:
                topicTextToBeDisplayed.text = "(Topic: Approximation and Estimation)";
                break;
            case 3:
                topicTextToBeDisplayed.text = "(Topic: Algebra and Algebraic Manipulation)";
                break;
            case 4:
                topicTextToBeDisplayed.text = "(Topic: Linear Equations and Simple Inequalities)";
                break;
            case 5:
                topicTextToBeDisplayed.text = "(Topic: Number Patterns)";
                break;
            case 6:
                topicTextToBeDisplayed.text = "(Topic: Percentage)";
                break;
            case 7:
                topicTextToBeDisplayed.text = "(Topic: Ratio, Rate and Speed)";
                break;
            case 8:
                topicTextToBeDisplayed.text = "(Topic: Basic Geometry)";
                break;
            case 9:
                topicTextToBeDisplayed.text = "(Topic: Triangles, Quadrilaterals and Polygons)";
                break;
            case 10:
                topicTextToBeDisplayed.text = "(Topic: Functions and Linear Graphs)";
                break;
            case 11:
                topicTextToBeDisplayed.text = "(Topic: Perimeter and Area of Plane Figures)";
                break;
            case 12:
                topicTextToBeDisplayed.text = "(Topic: Geometrical Construction)";
                break;
            case 13:
                topicTextToBeDisplayed.text = "(Topic: Volume and Surface Area of Prisms and Cylinders)";
                break;
            case 14:
                topicTextToBeDisplayed.text = "(Topic: Statistical Data Handling)";
                break;
            default:
