...
public class BioQuizGameManager : MonoBehaviour
{
    // UI and interfaces
    ...
    private static List<BioQuestion> unansweredQuestions;
    private static int questionCount = 0;       // count and display the question number, will be reset whenever user leaves the quiz


    private BioQuestion currentQuestion;

    public List<BioQuestion> answeredQuestions;       // to be used for the summary page
    ...
    private void Start()
    {
       ...
       // Debug.Log(relatedQuestions.Count);
        ...
        {
            unansweredQuestions = selectedQuestions.ToList<BioQuestion>();
        }
    ...
    public void SetNextQuestionOrEnd()
    {
        ...
        if (questionCount == 5)
        {
            ...
            EndQuiz(5);                                             // CHANGE ACCORDING TO SUBJECT
    ...
    void DisplayQuestionTopic(int questionTopicNum, TextMeshProUGUI topicTextToBeDisplayed)
    {
        ...
        {
            case 0:
                topicTextToBeDisplayed.text = "(Topic: Laboratory safety)";
                break;
            case 1:
                topicTextToBeDisplayed.text = "(Topic: Classification of living things)";
                break;
            case 2:
                topicTextToBeDisplayed.text = "(Topic: Classification of materials)";
                break;
            case 3:
                topicTextToBeDisplayed.text = "(Topic: Cells)";
                break;
            case 4:
                topicTextToBeDisplayed.text = "(Topic: Energy in nature)";
                break;
            default:
