...
public class Ma_ForTopicButtons : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (numTimesMainPageStarted != QuizUnlockMaTerms.instance.numTimesEnterPage)
        {
            selected = false;
            numTimesMainPageStarted = QuizUnlockMaTerms.instance.numTimesEnterPage;
        }
