...
public class QuizUnlockChemTerms : MonoBehaviour
{
    ...
    public static QuizUnlockChemTerms instance;
    ...
    public Button CHEM_startButton;
    ...
    private void Update()
    {
        ...
        {
            CHEM_startButton.interactable = false;
        ...
        {
            CHEM_startButton.interactable = true;         // if selected any1 of the topics, can start quiz already
        }
    }
    ...
    public void ChemClearSelectedArray()
    {
        for (int i = 0; i < 3; i++)
        {
            selectedTopics[i] = 0;
    ...
    // to be placed in chem start button
    public void CHEM_OnStartingQuiz()
    {
        ...
        Invoke("LoadChemQuiz", 0.05f);   // delay to ensure playerprefs are set first. 
