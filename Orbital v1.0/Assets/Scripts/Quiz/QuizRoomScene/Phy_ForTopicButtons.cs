...
public class Phy_ForTopicButtons : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (numTimesMainPageStarted != QuizUnlockPhyTerms.instance.numTimesEnterPage)
        {
            selected = false;
            numTimesMainPageStarted = QuizUnlockPhyTerms.instance.numTimesEnterPage;
        }
