...
public class QuizUnlockMaTerms : MonoBehaviour
{
    ...
    public static QuizUnlockMaTerms instance;
    ...
    private void Update()
    {
        ...
        {
            MA_startButton.interactable = false;
        ...
        else if (selectedTopics[0] != 0 && selectedTopics[1] != 0 && selectedTopics[2] != 0)    // if 3 topics selected, cant choose anymore
        {
            ...
            Term1topic3.interactable = false;
            Term1topic4.interactable = false;
            Term1topic5.interactable = false;

            Term2topic1.interactable = false;
            Term2topic2.interactable = false;
            Term2topic3.interactable = false;
            Term2topic4.interactable = false;
            Term2topic5.interactable = false;

            Term3topic1.interactable = false;
            Term3topic2.interactable = false;
            Term3topic3.interactable = false;
            Term3topic4.interactable = false;
            Term3topic5.interactable = false;
        ...
        {
            MA_startButton.interactable = true;         // if selected any1 of the topics, can start quiz already
        }
    }
    ...
    // for the buttons, input in their topic index for the quiz scene to select the questions
    ...
    public void MaClearSelectedArray()
    {
        for (int i = 0; i < 3; i++)
        {
            selectedTopics[i] = 0;
    ...
    // to be placed in Math start button
    public void MA_OnStartingQuiz()
    {
        ...
        Invoke("LoadMathQuiz", 0.05f);   // delay to ensure playerprefs are set first. 

    }

    private void LoadMathQuiz()
    {
