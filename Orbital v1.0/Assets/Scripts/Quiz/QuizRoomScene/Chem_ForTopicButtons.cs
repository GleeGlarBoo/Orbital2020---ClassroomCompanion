...
public class Chem_ForTopicButtons : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (numTimesMainPageStarted != QuizUnlockChemTerms.instance.numTimesEnterPage)
        {
            selected = false;
            numTimesMainPageStarted = QuizUnlockChemTerms.instance.numTimesEnterPage;
        }
