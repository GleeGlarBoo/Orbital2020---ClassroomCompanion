...
public class QuizUnlockBioTerms : MonoBehaviour
{
    ...
    public static QuizUnlockBioTerms instance;
    ...
    private void Update()
    {
        ...
        {
            BIO_startButton.interactable = false;
        ...
        {
            BIO_startButton.interactable = true;         // if selected any1 of the topics, can start quiz already
        }
    }
    ...
    public void BioClearSelectedArray()
    {
        for (int i = 0; i < 3; i++)
        {
            selectedTopics[i] = 0;
    ...
    // to be placed in Bio start button
    public void BIO_OnStartingQuiz()
    {
        ...
        Invoke("LoadBioQuiz", 0.05f);   // delay to ensure playerprefs are set first. 

    }

    public void LoadBioQuiz()
    {
