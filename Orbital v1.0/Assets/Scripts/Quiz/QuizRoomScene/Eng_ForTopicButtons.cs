...
public class Eng_ForTopicButtons : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (numTimesMainPageStarted != QuizUnlockEngTerms.instance.numTimesEnterPage)
        {
            selected = false;
            numTimesMainPageStarted = QuizUnlockEngTerms.instance.numTimesEnterPage;
        }
